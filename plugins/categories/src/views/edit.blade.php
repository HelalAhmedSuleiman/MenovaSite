                                ...
                                @foreach(config("i18n.locales") as $key => $locale)
                                    ...
                                    <div id="tab-{{ $key }}"
                                        ...
                                        <div class="form-group">
                                            <label
                                                    for="input-name">{{ trans("categories::categories.attributes.name", [], $key) }}</label>
                                            <input name="name[{{$key}}]" type="text"
                                                   value="{{ @Request::old("name", $category->name->$key) }}"
                                        ...
                                        <div class="form-group">
                                            <label
                                                    for="input-slug">{{ trans("categories::categories.attributes.slug", [], $key) }}</label>
                                            <input name="slug[{{$key}}]" type="text"
                                                   value="{{ @Request::old("slug", $category->slug->$key) }}"
